...
[[https://discord.doomemacs.org][our Discord]] or [[https://discuss.doomemacs.org][Github Discussions]].
...
progress, feel free to ping him in-thread or [[https://discord.doomemacs.org][on Discord]] (in the #contributing
channel).
...
- A post asking how to configure or use Emacs to achieve some effect (our issue
  tracker is for bug reports, not support; ask on [[https://discord.doomemacs.org][Discord]] or [[https://discourse.doomemacs.org][Discourse]] instead).
